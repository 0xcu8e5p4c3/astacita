<div class="relative bg-gray-50 px-6 pt-16 pb-20 lg:px-8 lg:pt-24 lg:pb-28">
  ...
  <div class="relative mx-auto max-w-7xl">
    <div class="container mx-auto px-4">
       <h1 class="text-2xl font-bold mb-4">Most Viewed</h1>
      ...
      <div class="flex flex-col overflow-hidden rounded-lg shadow-lg">
        ...
        <div class="flex flex-1 flex-col justify-between bg-white p-6">
          <div class="flex-1">
            ...
            <span class="bg-white shadow-md text-xs font-bold px-3 py-1 rounded">AI</span>
            </p>
            <a href="#" class="mt-2 block">
              <p class="text-xl font-semibold text-gray-900 hover:text-blue-600 transition duration-300">Boost your conversion rate</p>
      ...
      <div class="flex flex-col overflow-hidden rounded-lg shadow-lg">
        ...
        <div class="flex flex-1 flex-col justify-between bg-white p-6">
          <div class="flex-1">
            ...
            <a href="#" class="mt-2 block">
              <p class="text-xl font-semibold text-gray-900 hover:text-blue-600 transition duration-300">How to use search engine optimization to drive sales</p>
              <p class="mt-3 text-base text-gray-500">Lorem ipsum dolor sit amet consectetur adipisicing elit. Velit
                facilis asperiores porro quaerat doloribus, eveniet dolore. Adipisci tempora aut inventore optio animi. tempore temporibus quo laudantium.</p>
            </a>
          </div>
          <div class="mt-6 flex items-center">
            <div class="flex-shrink-0">
      ...
      <div class="flex flex-col overflow-hidden rounded-lg shadow-lg">
        ...
        <div class="flex flex-1 flex-col justify-between bg-white p-6">
          <div class="flex-1">
            ...
            <a href="#" class="mt-2 block">
              <p class="text-xl font-semibold text-gray-900 hover:text-blue-600 transition duration-300">Improve your customer experience</p>
